        ...
        <nav className="navbar navbar-expand-lg navbar-light bg-light Navbar-border fixed-top">
          <Link className="navbar-brand" to="/">
            <div className='NavbarLogoPart3 mr-4 ml-2'>
              <svg height="35px" viewBox="0 0 512 512" transform='translate(0,-8)' width="35px" xmlns="http://www.w3.org/2000/svg" >
          ...
          <div className="collapse navbar-collapse justify-content-between ml-5" id="navbarSupportedContent">
              ...
              <ul className='navbar-nav mr-auto'>
                ...
                <li className={'nav-item pr-3 '  + (this.state.isLogged ? 'hidden' : '')}>
                  <Link className='font-weight-bold navbar-Font-Size nav-link cursor-pointer position-relative' to="/zaloguj">
                    ...
                    <i className='bigicon fas fa-shopping-cart'></i><span className="badge badge-primary navbarCartStyle position-absolute">{this.state.CartItems}</span>
                  </Link>
                </li>
                <li className={'nav-item pr-3 '  + (this.state.isLogged ? '' : 'hidden')}>
