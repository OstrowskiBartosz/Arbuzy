...
router.post("/", function(req, res, next) {
  ...
  var sql =
    "SELECT produkty.id_produktu, produkty.nazwa_produktu, atrybuty.wartosc, ceny.cena_brutto " +
  ...
  con.query(sql, function(err, result) {
    ...
    var sql =
      "SELECT p.id_produktu, p.nazwa_produktu, c.cena_brutto, a.wartosc, sum(pf.ilosc) as sprzedanych " +
